...
my $session = new CGI::Session::MySQL(undef, $_options);
...
my $new_session = new CGI::Session::MySQL($sid, $_options);
...
my $another_new_session = new CGI::Session::MySQL( $sid, $_options );
